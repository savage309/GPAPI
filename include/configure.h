...
//! \brief Common defines used to set the project configuration
...
//! \brief Sets the target, for which the project should be build. TARGET_CUDA, TARGET_OPENCL and TARGET_NATIVE are available
#define TARGET_CUDA
